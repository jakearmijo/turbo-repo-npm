...
export interface HeadspaceOption {
  value: number;
  label: string;
}
...
export type HeadspaceOptionType = z.infer<typeof HeadspaceOptionSchema>;
export type HeadspaceOptionsType = Array<z.infer<typeof HeadspaceOptionSchema>>;
